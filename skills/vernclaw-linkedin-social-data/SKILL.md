...
license: MIT
description: Use when calling LinkedIn social data operations through Vernclaw's CLI.
---

# LinkedIn Social Data — CLI Skill

Call LinkedIn operations through Vernclaw Connect CLI and return normalized social data for AI agents.

## When to Use

- Run LinkedIn research from an agent workflow without managing separate credentials
...
| ------------- | -------- | --------------------------------------------------------------------------------------------------- |
| `--operation` | No       | Operation name. Defaults to `user_profile` when omitted.                                            |
