...
license: MIT
description: Use when calling TikTok social data operations through Vernclaw's CLI.
---

# TikTok Social Data — CLI Skill

Call TikTok operations through Vernclaw Connect CLI and return normalized social data for AI agents.

## When to Use

- Run TikTok research from an agent workflow without managing separate credentials
...
| ------------- | -------- | --------------------------------------------------------------------------------------------------- |
| `--operation` | No       | Operation name. Defaults to `general_search` when omitted.                                          |
