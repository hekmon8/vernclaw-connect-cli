...
license: MIT
description: Use when calling Weibo social data operations through Vernclaw's CLI.
---

# Weibo Social Data — CLI Skill

Call Weibo operations through Vernclaw Connect CLI and return normalized social data for AI agents.

## When to Use

- Run Weibo research from an agent workflow without managing separate credentials
