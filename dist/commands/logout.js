...
export async function runLogoutCommand(config, { force } = {}) {
    if (!force) {
        const readline = createInterface({ input, output });
        const answer = await readline.question('Are you sure you want to log out? This will remove stored credentials. (y/N): ');
        readline.close();
