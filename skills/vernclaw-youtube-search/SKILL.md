...
Most agents only need Vernclaw CLI authentication. If `search.youtube` is temporarily unavailable, retry shortly and contact Vernclaw support if the issue persists.
