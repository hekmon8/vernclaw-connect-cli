...
- `data` contains a normalized summary plus `items` rows with Product Hunt URL, website URL, name, tagline, makers, topics, public votes, comments, rank when available, `source`, `source_mode`, and limitations.
