...
## Invocation
**Note:** The `social.tikhub.linkedin` connector is currently not available in the offline catalog. The following examples are preserved for reference when this connector becomes available.

```bash
# vernclaw-cli invoke social.tikhub.linkedin --operation user_profile --params '{"keyword":"founder AI"}'
# vernclaw-cli describe social.tikhub.linkedin
```
...
## Workflow
**Note:** The `social.tikhub.linkedin` connector is currently not available in the offline catalog. The following workflow is preserved for reference when this connector becomes available.
