...
license: MIT
description: Use when calling Zhihu social data operations through Vernclaw's CLI.
---

# Zhihu Social Data — CLI Skill

Call Zhihu operations through Vernclaw Connect CLI and return normalized social data for AI agents.

## When to Use

- Run Zhihu research from an agent workflow without managing separate credentials
...
| ------------- | -------- | --------------------------------------------------------------------------------------------------- |
| `--operation` | No       | Operation name. Defaults to `hot_list` when omitted.                                                |
